document.addEventListener("DOMContentLoaded", () => {
  ...
  const skillData = {
    ...
    flutter: {
      ...
      use: {
        es: "Construir interfaces multiplataforma con alto rendimiento y una sola base de codigo.",
        en: "Build high-performance cross-platform interfaces from a single codebase.",
      },
    },
    dart: {
      docs: "https://dart.dev/guides",
      use: {
        es: "Modelar logica de aplicacion, estado y arquitectura en proyectos Flutter.",
        en: "Model application logic, state, and architecture in Flutter projects.",
      },
    },
    firebase: {
      docs: "https://firebase.google.com/docs",
      use: {
        es: "Resolver autenticacion, datos, almacenamiento y servicios backend rapidamente.",
        en: "Handle authentication, data, storage, and backend services quickly.",
      },
    },
    figma: {
      docs: "https://help.figma.com/",
      use: {
        es: "Disenar pantallas, sistemas visuales y prototipos antes de implementar.",
        en: "Design screens, visual systems, and prototypes before implementation.",
      },
    },
  };
  ...
  const openPopup = (trigger) => {
    ...
    const pdfBlock = pdfUrl
      ? `<iframe class="popup-pdf" src="${escapeHtml(pdfUrl)}#page=1&view=Fit&toolbar=0&navpanes=0&scrollbar=0" title="${escapeHtml(skillName)} PDF preview" loading="lazy"></iframe>`
      : "";
    const courseMeta =
      getDataAttrLang(trigger, "date") || getDataAttrLang(trigger, "issuer")
