document.addEventListener('DOMContentLoaded', () => {
    ...
    const openPopup = (trigger) => {
        ...
        const pdfBlock = pdfUrl
            ? `<iframe class="popup-pdf" src="${escapeHtml(pdfUrl)}#page=1&view=FitH&toolbar=0&navpanes=0&scrollbar=0" title="${escapeHtml(skillName)} PDF preview" loading="lazy"></iframe>`
            : '';
